...
# 학습된 모델 경로
classification_model_path = "model/error_classification_model_16_16_100_klue_human"
qa_model_path = "model/qa_model_16_16_100_human"
...
if question:
    ...
    with torch.no_grad():
        ...
        start_index = torch.argmax(start_logits[0, 1:])
        end_index = torch.argmax(end_logits[0, 1:]) + 1
